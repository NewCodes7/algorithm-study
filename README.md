...
- [ ] sql 정리
- [ ] 해당 시험과 관련하여 특이사항 (제한시간, 캠, 레퍼런스, vscode 단축키, 물되나? 등) (컨트롤 c, x안됨.) 줄 지우려면 커맨드 백스페이스
- [ ] 최단 경로 알고리즘 읽어보기


### 전체 시험 흐름도
- sql 20, 알고리즘1 40, 알고리즘2 50
  - 새로운 문제 도전: 30분만 있어도 할만함. (3시 반까지는 sql, 알고리즘1 마무리)
...
- 알고리즘1, sql1 풀고 검토까지 마쳤다면, 새 문제 도전
...
- 90도 rotate: rotate[i][j] = arr[n-1-j][i];
