...
- 🔥 Math 메서드 주의: int c = (int) Math.ceil(1032 * 0.54);
...
### 백트랙킹, DFS, BFS
- 🔥 본질: 순서, 문어발(위아래)
- 🔥 유형: 순열(visited), 조합(i+1), 같순열(arr[i]--, == 0 continue), 채워넣기(i-문어발을 생각해!, continue)(순서x)(중복조합과 유사)
